...
- name: BOARD_InitPeripherals
  UUID: 1bb6974a-4bc4-479b-a0a6-8d49a249c886
  called_from_default_init: true
  selectedCore: core0
- name: BOARD_InitButtonsPeripheral
  UUID: 1f19dc6c-8e32-4f0a-bfc2-da102368e078
  id_prefix: BOARD_
  selectedCore: core0
- name: BOARD_InitLEDsPeripheral
  UUID: 03c662a7-c4c9-4716-9128-d3b0dfca3462
  id_prefix: BOARD_
  selectedCore: core0
- name: BOARD_InitACCELPeripheral
  UUID: 21d81b76-4aed-4b0e-88fc-020f84adbab0
  id_prefix: BOARD_
  selectedCore: core0
- name: BOARD_InitMAGPeripheral
  UUID: bd968ad1-6bd6-4497-9ecb-8eeecdb59b9d
  selectedCore: core0
- name: BOARD_InitDEBUG_UARTPeripheral
  UUID: ee96f699-d64d-4961-ab55-04f05c4b0a46
  id_prefix: BOARD_
  selectedCore: core0
